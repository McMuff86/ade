...
const valid: Record<InvokeChannel, unknown> = {
  ...
  'dictation:streamStart': { jobId: '11111111-1111-4111-8111-111111111111' },
  'dictation:streamChunk': { jobId: '11111111-1111-4111-8111-111111111111', sequence: 0, audioBase64: 'AAAA' },
  'dictation:streamFinish': { jobId: '11111111-1111-4111-8111-111111111111' },
  ...
  'mobileAccess:setEnabled': { enabled: true },
  'mobileAccess:pair': undefined,
  ...
  'agent:behaviorGet': { agentId: 'agent-a' },
  'agent:behaviorSet': { agentId: 'agent-a', revision: 'a'.repeat(64), profile: { instructions: '', documents: [] } },
  ...
  'repository:syncOverview': { repositoryId: 'repository' },
  'repository:fetch': { repositoryId: 'repository' },
  'repository:syncPreview': { repositoryId: 'repository', targetId: 'repository', sourceRef: 'refs/heads/main' },
  'repository:syncApply': { previewId: '11111111-1111-4111-8111-111111111111' },

...
const SUITES: Suite[] = [
  ...
  { id: 'remote-dictation', script: 'test-remote-dictation.ts', floors: { win32: 46 } },
  ...
  { id: 'terminal-workspace-identity', script: 'test-terminal-workspace-identity.ts', floors: { win32: 16 } },

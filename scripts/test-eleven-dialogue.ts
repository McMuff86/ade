...
void (async () => {
  ...
  check('ordinary answers speak a standalone Agent in English while compounds and visible text stay', speechPronunciation('Dein Agent meldet: Agenten sind fertig.') === 'Dein "/ˈeɪ.dʒənt/" meldet: Agenten sind fertig.');

...
export const CHANNEL_POLICY: Readonly<Record<InvokeChannel, ChannelPolicy>> = {
  ...
  'speech:reply': { effect: 'host', surface: 'desktop', audit: true },
  'speech:preferences': { effect: 'host', surface: 'desktop', audit: false },
  'agent:behaviorGet': { effect: 'host', surface: 'desktop', audit: false },
  'supervision:get': { effect: 'read', surface: 'desktop', audit: false },
  'conversation:get': { effect: 'read', surface: 'desktop', audit: false },
  'organizer:query': read,
  'organizer:command': { ...mutate, audit: true },
  'organizer:dictationPrepare': { ...mutate, audit: true },
  ...
  'supervision:handoff': { effect: 'read', surface: 'desktop', audit: false },
  'agent:behaviorSet': { effect: 'mutate', surface: 'desktop', audit: true },
  'speech:configure': mutate,
  'terminal:promptQuery': read,
  'terminal:promptSend': launch,
  'dictation:prepare': { ...mutate, audit: true },
  'dictation:submit': { effect: 'host', surface: 'desktop', audit: true },
  'dictation:query': read,
  'dictation:cancel': { ...mutate, audit: true },
  'dictation:microphone': host,
  'dictation:streamStart': { effect: 'host', surface: 'desktop', audit: true },
  'dictation:streamChunk': { effect: 'host', surface: 'desktop', audit: false },
  'dictation:streamFinish': { effect: 'host', surface: 'desktop', audit: true },

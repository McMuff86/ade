export const REMOTE_ADMIN_SCOPES = ['host:restart', 'catalog:write', 'repositories:write', 'workspace:read', 'terminal:control', 'workspace:write', 'profiles:write', 'projects:write', 'projectGit:write', 'projectGit:publish', 'speech:control', 'dictation:transcribe'] as const;

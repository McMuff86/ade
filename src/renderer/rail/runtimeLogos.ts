...
const ollama = new URL('../assets/runtime-logos/ollama.svg?no-inline', import.meta.url).href;
...
export function runtimeLogo(runtime?: RuntimeId): string | undefined {
  return runtime === 'codex' ? codex : runtime === 'claude' ? claude : runtime === 'grok' ? grok : runtime === 'ollama' ? ollama : undefined;
}

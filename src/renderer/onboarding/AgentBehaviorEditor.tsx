...
export function AgentBehaviorEditor({ agentId, port, enabled = true, canEdit = true }: {
  ...
  return <section className="agent-behavior-editor" aria-label="Agent-Verhalten">
    ...
    <p>Interaktive Profilanweisungen unterstützen derzeit native Windows-Starts mit Codex, Claude oder Ollama-Coding über Codex CLI und Qwen Code. Andere Laufzeiten und eigene Startbefehle können ein gespeichertes Verhalten noch nicht übernehmen.</p>

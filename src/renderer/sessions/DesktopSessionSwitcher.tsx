...
export function DesktopSessionSwitcher({ onClose }: { onClose(): void }) {
  ...
  return <Modal title="Arbeit wechseln" onClose={onClose} className="session-switch-dialog" fallbackFocus={() => document.getElementById(`mode-tab-${useMode.getState().mode}`)}>
